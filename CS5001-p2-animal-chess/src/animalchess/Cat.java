...
/**
 * A class to define the Cat Piece and its behaviour.
 * <p>
...
public class Cat extends PromotablePiece {
    ...
    /**
     * The method for Cat to get its legal moves.
     *
     * @return a list of squares which is the legal moves for Cat
     */
    @Override
    public ArrayList<Square> getLegalMoves() {
        ...
        Point[] originalPotentialMovesForP0 = {
                new Point(nowRow - 1, nowCol - 1), new Point(nowRow - 1, nowCol + 1),
